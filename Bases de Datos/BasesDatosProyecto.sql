...
-- -----------------------------------------------------
-- Table `Tech Organice`.`TipoDocumento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Tech Organice`.`TipoDocumento` (
  `id_tipoDocumento` INT NOT NULL AUTO_INCREMENT COMMENT 'id autoincremental\n',
  `nombre_tipoDocumento` VARCHAR(40) NOT NULL COMMENT 'Tipo de Documento del Usuario',
  `acronimo` VARCHAR(40) NOT NULL COMMENT 'Acronimo del Tipo de Documento',
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Usuario` (
  `numeroDocumento` VARCHAR(45) NOT NULL COMMENT 'Numero del documento del Usuario',
  `NombreUsuario` VARCHAR(45) NOT NULL COMMENT 'Nombre que tendra el Usuario en la pagina',
  `Correo` VARCHAR(45) NOT NULL COMMENT 'Correo con el cual ingresara el Usuario',
  `numerocelular` VARCHAR(45) NOT NULL COMMENT 'Numero del celular del Usuario para recuperacion de cuenta',
  `Contraseña` VARCHAR(256) NOT NULL COMMENT 'Contraseña que tendra el Usuario (Max 10 caracteres-Min 6 caracteres)',
  `ROL_id_ROL` INT NOT NULL COMMENT 'Rol asignado al Usuario',
  `TipoDocumento_id_tipoDocumento` INT NOT NULL,
  PRIMARY KEY (`numeroDocumento`),
  INDEX `fk_Usuario_ROL1_idx` (`ROL_id_ROL` ASC),
  INDEX `fk_Usuario_TipoDocumento1_idx` (`TipoDocumento_id_tipoDocumento` ASC),
  ...
  CONSTRAINT `fk_Usuario_TipoDocumento1`
    FOREIGN KEY (`TipoDocumento_id_tipoDocumento`)
    REFERENCES `Tech Organice`.`TipoDocumento` (`id_tipoDocumento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`reporteserrores` (
  `Administrador` VARCHAR(45) NOT NULL COMMENT 'Se encargara de revisar y solucionar los Reportes enviados',
  `Usuario_numeroDocumento` VARCHAR(45) NOT NULL COMMENT 'Numero del documento del Usuario',
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Archivos` (
  `ID_Archivo` INT NOT NULL AUTO_INCREMENT COMMENT 'Codigo de identificacion del Archivo',
  `Usuario_numeroDocumento` VARCHAR(45) NOT NULL COMMENT 'Numero del documento del Usuario',
  `NombreArchivo` VARCHAR(45) NOT NULL COMMENT 'Nombre que tiene el Archivo',
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`almacenamientonube` (
  `ID_Almacenamiento` INT NOT NULL AUTO_INCREMENT COMMENT 'Codigo para identificar el tipo de almacenamiento',
  `AlmacenamientoEstandar` BLOB(50) NOT NULL COMMENT '50 GB de espacio basico',
  `Almacenamiento1` BLOB(100) NOT NULL COMMENT '100GB de espacio de almacenamiento',
  `Almacenamiento2` BLOB(200) NOT NULL COMMENT '200GB de espacio de almacenamiento',
  `Almacenamiento3` BLOB(500) NOT NULL COMMENT '500GB de espacio de almacenamiento',
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Log Error/Virus` (
  ...
  INDEX `fk_Log Error/Virus_Archivos1_idx` (`Archivos_ID_Archivo` ASC),
  CONSTRAINT `fk_Log Error/Virus_Archivos1`
    FOREIGN KEY (`Archivos_ID_Archivo`)
    REFERENCES `Tech Organice`.`Archivos` (`ID_Archivo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Factura` (
  `ID_Factura` INT NOT NULL AUTO_INCREMENT COMMENT 'Codigo de compra',
...
-- -----------------------------------------------------
-- Table `Tech Organice`.`Plan_Deseado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Plan_Deseado` (
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Plan Deseado_has_Usuario` (
  ...
  `Usuario_numeroDocumento` VARCHAR(45) NOT NULL COMMENT 'Llave foranea numero documento Usuario',
  ...
  CONSTRAINT `fk_Plan Deseado_has_Usuario_Plan Deseado1`
    ...
    REFERENCES `Tech Organice`.`Plan_Deseado` (`ID_Plan`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Pago` (
  `id_Pago` INT NOT NULL AUTO_INCREMENT COMMENT 'Codigo generado en base al pago',
...
-- -----------------------------------------------------
-- Table `Tech Organice`.`Configuraciones_Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Configuraciones_Usuario` (
  ...
  `Usuario_numeroDocumento` VARCHAR(45) NOT NULL COMMENT 'Llave foranea Usuario',
