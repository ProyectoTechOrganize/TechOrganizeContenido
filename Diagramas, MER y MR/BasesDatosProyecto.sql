...
-- -----------------------------------------------------
-- Table `Tech Organice`.`tipo_de_documento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Tech Organice`.`tipo_de_documento` (
...
CREATE TABLE IF NOT EXISTS `Tech Organice`.`Usuario` (
  ...
  `tipo de documento_id_tipoDocumento` VARCHAR(10) NOT NULL,
  ...
  CONSTRAINT `fk_Usuario_tipo de documento1`
    ...
    REFERENCES `Tech Organice`.`tipo_de_documento` (`id_tipoDocumento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
